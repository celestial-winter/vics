...
(function (API) {
    ...
    var themes = {
        ...
        grid: {
            table: {fillColor: 255, textColor: 0, fontStyle: "normal", lineWidth: 1, fillStyle: "DF"},
            header: {textColor: 255, fillColor: [26, 188, 156], rowHeight: 23, fillStyle: "F", fontStyle: "normal"},
            body: {},
        },
